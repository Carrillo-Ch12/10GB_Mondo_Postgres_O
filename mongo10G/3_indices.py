...
# -*- coding: utf-8 -*-
"""
Crea BD TPC-H en MongoDB con indices especificos por query TPC-H
Sin compresion (block_compressor=none)
Lee desde tpch_base y escribe en tpch_indices
...
def main():
    ...
    print("=" * 70)
    print("SETUP TPC-H INDICES - MONGODB - NODO CENTRALIZADO")
    ...
    print("\n[1/3] Creando colecciones sin compresion...")
    for table in TABLES:
        create_collection_no_compression(dst_db, table)
        print(f"  [OK] {table}")
